...
function initSell()
  ...
  local number = 16 --unique for each verb
  local words = {"Sell", "barter", "sell"};--aliases for this verb
  ...
  handlers[number] = handleSell;--add this verb's functions to the handlers{}

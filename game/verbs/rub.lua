...
function initRub()
  ...
  local number = 21 --unique for each verb
  local words = {"rub", "Rub"};--aliases for this verb
  ...
  handlers[number] = handleRub;--add this verb's functions to the handlers{}

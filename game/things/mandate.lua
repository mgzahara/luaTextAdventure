...
function mandateinit()
	local myNumber = nextNumber;
	nextNumber = nextNumber + 1;
	
	mapping["UN mandate"] = {[0] = myNumber, [1] = 0};
	
	items[myNumber] = {[0] = "UN mandate", [1] = -1, [2] = 0, [3] = "a", [4] = useMandate};
...
function useMandate(arg, target)
-- arg == verb used on this item
--target == ???
	local mynum = mapping["UN mandate"][0];

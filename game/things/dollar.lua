...
function dollarinit()
	...
	mapping["dollar"] = {[0] = myNumber, [1] = 0};
	mapping["buck"] = {[0] = myNumber, [1] = 0};
	mapping["money"] = {[0] = myNumber, [1] = 0};
	mapping["chedda"] = {[0] = myNumber, [1] = 0};
	mapping["green back"] = {[0] = myNumber, [1] = 0};
	mapping["big one"] = {[0] = myNumber, [1] = 0};
	
	items[myNumber] = {[0] = "crisp one dollar bill", [1] = 1, [2] = 0, [3] = "a", [4] = useDollar};
...
function useDollar(arg, target)
	local mynum = mapping["dollar"][0];
